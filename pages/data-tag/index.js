      ...
      <div className='container mx-auto mt-4 mb-10 p-5 bg-gray-800 rounded-lg shadow-lg max-w-sm'>
        <div className='flex flex-col gap-10'>
          ...
          <div className='flex flex-col'>
            <label className='text-white mb-2 font-bold text-xl text-center' htmlFor='buildNumber'>
              Scan Build Number:
            </label>
            <input
              className={`rounded p-2 w-full border-2 ${
                validationErrors.buildNumber ? 'border-red-500' : 'border-gray-200'
              ...
              required
            />
            {validationErrors.buildNumber && <p className='text-red-500 text-sm'>{validationErrors.buildNumber}</p>}
          </div>

          {/* Datatag ID Input */}
          <div className='flex flex-col'>
            <label className='text-white mb-2 font-bold text-xl text-center' htmlFor='datatagID'>
              Scan Datatag:
            </label>
            <input
              className={`rounded p-2 w-full border-2 ${
                validationErrors.datatagID ? 'border-red-500' : 'border-gray-200'
              } text-black text-lg placeholder-gray-500`}
              type='text'
              id='datatagID'
              value={datatagID}
              ...
              required
            />
            {validationErrors.datatagID && <p className='text-red-500 text-sm'>{validationErrors.datatagID}</p>}
          </div>

          {/* Clock Card Input */}
          <div className='flex flex-col'>
            <label className='text-white mb-2 font-bold text-xl text-center' htmlFor='clockCard'>
              Scan Clock Card:
            </label>
            <input
              className={`rounded p-2 w-full border-2 ${
                validationErrors.clockCard ? 'border-red-500' : 'border-gray-200'
              } text-black text-lg placeholder-gray-500`}
              type='text'
              id='clockCard'
              value={clockCard}
              ...
              required
            />
            {validationErrors.clockCard && <p className='text-red-500 text-sm'>{validationErrors.clockCard}</p>}
          </div>
